...
namespace ProjectSDL2
{
    public class redblacktree
    {
        ...
        public List<Lingkaran2> lingkaran = new List<Lingkaran2>();
        

        int ctrGaris = 1;
        int ctrLingkaran = 1;
        Form2 parent;
        public redblacktree(Form2 parent)
        {
            root = null;
            this.parent = parent;
        }
        ...
        public void addlingkaran(ref NodeAVL root)
        {
            ...
            if (root.passed)
            {
                lingkaran.Add(new Lingkaran2(root.x, root.y, root.value.ToString(), Color.Yellow));
            }
            else
            {
                lingkaran.Add(new Lingkaran2(root.x, root.y, root.value.ToString(), root.color));
            }
        }
        // Summary 
        // Update Ling Karan
        ...
        // Summary
        // Replace node in parent and balancing 
